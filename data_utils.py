...
class Dataset_train(Dataset):
    def __init__(self, args, list_IDs, labels, scores, base_dir, algo):
    ...
    def __getitem__(self, index):
        ...
        if random.random() > 0.6:
            ...
            Y=process_Rawboost_feature(X, fs, self.args, 0)
...
class Dataset_eval(Dataset):
    ...
    #def __init__(self, list_IDs, scores, base_dir, track):
